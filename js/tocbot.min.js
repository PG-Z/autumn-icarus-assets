(() => {
    var e = {
        539: (e, t, n) => {
            ...
            function o(e) {
                var t, n = [].forEach, o = [].some, l = document.body, r = !0, i = " ";

                function s(t, o) {
                    var l, r, a,
                        u = o.appendChild((l = t, r = document.createElement("li"), a = document.createElement("a"), e.listItemClass && r.setAttribute("class", e.listItemClass), e.onClick && (a.onclick = e.onClick), e.includeTitleTags && a.setAttribute("title", l.textContent), e.includeHtml && l.childNodes.length ? n.call(l.childNodes, (function (e) {
                ...
                s.render(n, m), u = g((function (e) {
                    s.updateToc(a), !f.disableTocScrollSync && function (e) {
                        ...
                        if (t && t.scrollHeight > t.clientHeight) {
                            ...
                            if (n) {
                                var o = t.scrollTop, l = o + t.clientHeight, r = n.offsetTop, s = r + n.clientHeight;
            ...
            function g(e, t, n) {
                ...
                return t || (t = 250), function () {
                    const r = n || this, i = +new Date, s = arguments;
